            ...
            <div class="row">
                <div id="header-text" class="text-left col-md-8">
                    <p>
                        ...
                        well as to highlight the many independent and team projects I have completed that
                        illustrate my initiative and technical ability.
                    </p>
                    ...
                    <p>
                        <strong>I am self-driven and my passion is programming and making things.</strong> I love
                        building software, electronics, robots, and machines. If I'm not working on a project, I'm
                        looking for a new one. I am constantly researching new ways to do things, and looking for new
                        inspiration. Every day I read articles and watch videos about new emerging technologies,
                        current technology, and other things related to my field.
                    </p>

                    <p>
                        <strong>I enjoy talking to people, whether the topic is technology or a debate on current
                            events.</strong> I have given many presentations, including a radio interview, at the annual
                        County Fair where my 4-H robotics club exhibits its work. I am skilled at explaining
                        technical concepts. I am also a decent salesman. Part of my pen business involved selling to
                        the public.
                    </p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="assets/me.jpg" class="img-center img-circle img-responsive" height="400" width="400">
                </div>
            </div>
        </div>
    </header>
...
<!--            <a href="">
                <figure class="figure-effect">
                    ...
                    <figcaption>
                        ...
                        <div>
                            <p>A robot that drives around the</p>

                            <p>4-H fair and sells water bottles</p>
                        </div>
                    </figcaption>
                </figure>
            </a>-->
                ...
                <figure class="figure-effect">
                    ...
                    <figcaption>
                        ...
                        <div>
                            ...
                            <p>remote server applications</p>
                        </div>
                    </figcaption>
                </figure>
            </a>-->
